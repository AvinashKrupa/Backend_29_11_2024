  ...
  <body>
      <div class="container">
          ...
          <div class="content">
              ...
              <p>This OTP is valid for 10 minutes. If you didn’t request a password reset, please ignore this email. Your account is secure.</p>
...
`;
 ...
 export const Success_Forgot_Password_Email_Template = `
  <!DOCTYPE html>
  <html lang="en">
  <head>
      <meta charset="UTF-8">
  ...
  <body>
      <div class="container">
          <div class="header">Password Successfully Reset</div>
          <div class="content">
              <p class="message">Hi {name},</p>
